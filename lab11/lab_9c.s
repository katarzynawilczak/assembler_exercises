...
#ZMIENNOPRZECINKOWE PRZYBLIZENIE PI
#----------------------------------------------------------
...
denom_f:	
	.float	1.0, 3.0, 5.0, 7.0	# first, second, third and fourth denominators, mianowniki
numer_f:	
	.float	4.0, -4.0, 4.0, -4.0	# first, second, third and fourth numerators, liczniki
add8_f:	
	.float	8.0, 8.0, 8.0, 8.0	# difference between denominators, wartosci dodawane do mianownikow
zero_f:	
	.float	0.0, 0.0, 0.0, 0.0	# sums starting values, na poczatku suma zer
#----------------------------------------------------------
